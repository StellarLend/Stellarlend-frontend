      ...
      <div className="flex flex-col w-[90%] p-4">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="hidden md:flex space-x-6 items-center justify-between px-2">
            ...
            <NavLink href="/lend-borrow">Lend/Borrow</NavLink>
          </div>
          <div className="hidden md:flex text-white space-x-4">
            <Link href="/lend-borrow">
              <button className="px-3 py-2 rounded-sm hover:border hover:border-[#15A350]">Launch app</button>
            </Link>
            <button className="bg-[#15A350] text-white px-3 py-2 rounded-sm hover:opacity-80">Sign Up</button>
          </div>
