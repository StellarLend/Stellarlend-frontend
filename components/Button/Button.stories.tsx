...
const meta: Meta<typeof Button> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Buttons trigger actions or events. They should be used sparingly and clearly communicate the action they perform.",
      },
    },
  },
  argTypes: {
...
export const Secondary: Story = {
  ...
  parameters: {
    docs: { storyDescription: "Secondary actions, lower emphasis" },
  },
};
...
export const Ghost: Story = {
  ...
  parameters: {
    docs: { storyDescription: "Low emphasis, often used in toolbars" },
  },
};
...
export const Danger: Story = {
  ...
  parameters: {
    docs: { storyDescription: "Destructive actions like delete or remove" },
  },
};
