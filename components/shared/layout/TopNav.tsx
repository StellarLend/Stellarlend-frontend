...
const TopNav = () => {
  return (
    <div className="w-full flex flex-col sm:flex-row items-start sm:items-center justify-between bg-green-600 px-6 md:px-12 py-4 rounded-md gap-4 sm:gap-0">
      {/* Search Bar */}
      ...
      {/* Right Side Controls */}
      <div className="hidden md:flex flex-wrap sm:flex-nowrap items-center w-full sm:w-auto gap-3">
        {/* Network Selector */}
        ...
        {/* Divider */}
        <div className="h-8 border-l" style={{ borderColor: "#71B48D" }}></div>
