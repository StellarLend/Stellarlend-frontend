...
import { NotificationBellBase } from "@/components/shared/layout/NotificationBell";
import StreamStatusIndicator from "@/components/shared/layout/StreamStatusIndicator";
...
const TopNav = () => {
  ...
  const { unreadCount, connectionState } = useNotificationStream();
