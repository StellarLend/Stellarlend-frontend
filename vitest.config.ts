  ...
  test: {
...

      {
        ...
        test: {
          ...
          include: [
            ...
            "components/features/dashboard/components/PositionsOverviewGrid.test.tsx",
    ...
    coverage: {
      ...
      include: [
        ...
        "lib/transactions/presets.ts",
        "components/features/dashboard/components/FilterPresets.tsx",
        "lib/config.ts",
