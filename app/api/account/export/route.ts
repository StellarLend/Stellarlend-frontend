  ...
  try {
    ...
    console.log(
      JSON.stringify({
        ...
        userId,
        message:
          "User account archive compiled and short-lived signed access token generated successfully.",
      }),
    );
    ...
    return NextResponse.json(
      {
        success: true,
        message:
          "Export compilation complete. Your secure download path has been provisioned.",
        downloadUrl,
